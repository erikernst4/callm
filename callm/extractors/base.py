"""
Base answer extractors for parsing LLM responses.

Provides the foundational classes for extracting answers and confidence scores
from generated model text.
"""
