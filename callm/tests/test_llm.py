...
class TestLLMValidation:
    ...
    @patch('callm.models.llm.AutoTokenizer')
    @patch('callm.models.llm.CorrectnessEvaluator')
    def test_validation_step_structure(self, mock_evaluator, mock_tokenizer, mock_model):
        ...
        mock_tokenizer_instance.batch_decode.return_value = ["Guess: Paris\nProbability: 0.9"]
        ...
        # Run validation step
        result = llm.validation_step(batch, 0)
...
class TestConfigureOptimizers:
    ...
    @patch('callm.models.llm.AutoTokenizer')
    @patch('callm.models.llm.CorrectnessEvaluator')
    def test_returns_none_for_inference(self, mock_evaluator, mock_tokenizer, mock_model):
